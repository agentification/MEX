...
class AntGoalEnv(MultitaskAntEnv):
    def __init__(self, task={}, n_tasks=1, randomize_tasks=True, **kwargs):
...
class AntGoalEnvSparse(MultitaskAntEnv):
    def __init__(self, task={}, n_tasks=1, randomize_tasks=True, goal_radius=0.8, **kwargs):
